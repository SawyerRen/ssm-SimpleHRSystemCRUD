...
<head>
    ...
    <link
            ...
            rel="stylesheet">
    <script
            src="${pageContext.request.contextPath}/static/bootstrap-3.3.7-dist/js/bootstrap.min.js" type="text/javascript"></script>
</head>
<body>
<!-- 员工修改的模态框 -->
...
<script type="text/javascript">
    ...
    function build_page_info(result) {
        ...
        $("#page_info_area").append("当前" + result.extendMap.pageInfo.pageNum + "页,总" +
    ...
    function getDepts(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                //{"code":100,"msg":"处理成功！",
                //"extendMap":{"depts":[{"deptId":1,"deptName":"开发部"},{"deptId":2,"deptName":"测试部"}]}}
                //console.log(result);
                //显示部门信息在下拉列表中
                //$("#empAddModal select").append("")
                $.each(result.extendMapMap.depts, function () {
